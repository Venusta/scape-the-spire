...
public class ScapeTheSpire implements
    ...
    public ScapeTheSpire() {
        BaseMod.subscribe(this);

        BaseMod.addColor(TheScaper.Enums.SCAPER_COLOR, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheScaper(TheScaper.characterStrings.NAMES[1], TheScaper.Enums.THE_SCAPER),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheScaper.Enums.THE_SCAPER);
    }

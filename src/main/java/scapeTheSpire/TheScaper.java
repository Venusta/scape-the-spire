...
import static scapeTheSpire.ScapeTheSpire.*;
import static scapeTheSpire.TheScaper.Enums.SCAPER_COLOR;

public class TheScaper extends CustomPlayer {
  ...
  static final String ID = makeID("TheScaper");
  static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
  static final String[] NAMES = characterStrings.NAMES;
  static final String[] TEXT = characterStrings.TEXT;


  public TheScaper(String name, PlayerClass setClass) {
  ...
  public AbstractPlayer newInstance() {
    return new TheScaper(name, chosenClass);
  }
  ...
  public static class Enums {
    @SpireEnum
    public static AbstractPlayer.PlayerClass THE_SCAPER;
    @SpireEnum(name = "SCAPER_COLOR")
    public static AbstractCard.CardColor SCAPER_COLOR;
    @SpireEnum(name = "SCAPER_COLOR")
